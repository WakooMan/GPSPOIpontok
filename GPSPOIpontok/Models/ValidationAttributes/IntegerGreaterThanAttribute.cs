...
{
    public sealed class IntegerGreaterThanAttribute : ValidationAttribute
    {
        private readonly string testedPropertyName;
        private readonly bool allowEqualIntegers;

        public IntegerGreaterThanAttribute(string testedPropertyName, bool allowEqualIntegers = false)
        {
